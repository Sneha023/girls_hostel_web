...
<body>
  <div class="panel panel-warning">
    <div class="panel-heading">
      <h1 align="center"2>Confirmed Students List</h1>
    </div>
    ...
    $view1 = mysqli_query($connect,"select * from confirm_stud order by id asc") or die(mysqli_error($connect));
   // $total_records=mysqli_num_rows($view1);
     //echo "<h3>Number Of Confirm Students  : 12</h3>";
    //echo "<h3>No. Of Confirm Students :".$total_records."/12</h3>";
  ?>
