...
<body>
    ...
    <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper text-center">
            ...
            <a href="index.html">Home</a> » <span class="breadcrumb_last" aria-current="page">Gallery</span>
        </div>
    </nav>
    <div class="can">
    <div class="row">
        <div class="column">
          <img src="images/Gallery1.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
          <img src="images/Gallery.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
          <img src="images/Gallery3.jpg" alt="Mountains" style="width:100%">
        </div>
      </div>
      <div class="row">
        <div class="column">
          <img src="images/Gallery9.jpeg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
          <img src="images/Gallery8.jpeg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
          <img src="images/Gallery11.jpg" alt="Mountains" style="width:100%">
        </div>
      </div>
      <div class="row">
        <div class="column">
          <img src="images/Gallery10.jpeg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
          <img src="images/s2.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
          <img src="images/Gallery7.jpeg" alt="Mountains" style="width:100%">
        </div>
      </div>

      <div class="row">
        <div class="column">
          <img src="images/Gallery2.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
          <img src="images/room3.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
          <img src="images/r.jpg" alt="Mountains" style="width:100%">
        </div>
      </div>
      <div class="row">
        <div class="column">
        ...
        <div class="column">
          <img src="images/Gallery5.jpeg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
          <img src="images/hostel.jpg" alt="Mountains" style="width:100%">
        </div>
      </div>
