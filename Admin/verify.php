...
<section id="main-content">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
     <h2> Newly Registered Students Record</h2>
          </div>
    ...
    <?php
$view = mysqli_query($connect,"select * from student_detail order by
id desc") or die(mysqli_error($connect));
?>
...
<td>
  <button type="submit" name="login"  class="btn btn-success" class="form-control">Verify</button>
